...
public class SpringSecurityConfig {
    ...
    public SecurityFilterChain adminSecurityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers("/api/vendor/add-solutionset-infeedu").permitAll()
                        .requestMatchers("/var/www/infiniteb2b/springboot/whitepapersSet/**").permitAll()
                        .requestMatchers("/api/mail/html/demand-verse/**").permitAll()
                        .requestMatchers("/api/user/getall-favortie-category").permitAll()
    ...
    @Bean
    public HttpFirewall allowUrlEncodedDotHttpFirewall() {
